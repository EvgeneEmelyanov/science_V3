        ...
        try (SXSSFWorkbook wb = new SXSSFWorkbook(SXSSF_WINDOW)) {
            ...
            for (int b = 0; b < busCnt; b++) {
                ...
                if (DEBUG_WEIGHT_FACTORS) {
                    ...
                    writeHeaderCell(hdr, c++, "B" + bi + "_FR", headerStyle);
                    writeHeaderCell(hdr, c++, "B" + bi + "_FD", headerStyle);
            ...
            for (SimulationStepRecord rec : recs) {
                ...
                for (int b = 0; b < busCnt; b++) {
                    ...
                    if (DEBUG_WEIGHT_FACTORS) {
                        ...
                        writeNum1(row, cc++, btFr[b], num1Style);
                        writeNum1(row, cc++, btFd[b], num1Style);
